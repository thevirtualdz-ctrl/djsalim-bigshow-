  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-[#25D366] rounded-full shadow-[0_0_15px_rgba(37,211,102,0.5)] group-hover:shadow-[0_0_25px_rgba(37,211,102,0.8)] transition-shadow duration-300">
          <svg 
            viewBox="0 0 24 24" 
            fill="currentColor" 
            className="w-5 h-5 md:w-7 md:h-7 text-white ml-0.5 mt-0.5"
          >
